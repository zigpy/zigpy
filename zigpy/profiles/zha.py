...
CLUSTERS = {
    ...
    DeviceType.LIGHT_SENSOR: ([0x0007], [0x0004, 0x0005, 0x0006, 0x0008, 0x0300]),
    DeviceType.ON_OFF_BALLAST: ([0x0003,  0x0004, 0x0005, 0x0006, 0x0008, 0x0300], []),
    DeviceType.ON_OFF_PLUG_IN_UNIT:  ([0x0003,  0x0004, 0x0005, 0x0006, 0x0008, 0x0300], []),
    DeviceType.DIMMABLE_PLUG_IN_UNIT:   ([0x0003,  0x0004, 0x0005, 0x0006, 0x0008, 0x0300], []),
    DeviceType.COLOR_TEMPERATURE_LIGHT:  ([0x0003,  0x0004, 0x0005, 0x0006, 0x0008, 0x0300], []),
    DeviceType.EXTENTED_COLOR_LIGHT:  ([0x0003,  0x0004, 0x0005, 0x0006, 0x0008, 0x0300], []),
    DeviceType.LIGHT_LEVEL_SENSOR: ([0x0007], [0x0004, 0x0005, 0x0006, 0x0008, 0x0300]),
    DeviceType.NON_COLOR_CONTROLLER: ([0x0007], [0x0004, 0x0005, 0x0006, 0x0008, 0x0300]),
    DeviceType.NON_COLOR_SCENE_CONTROLLER: ([0x0007], [0x0004, 0x0005, 0x0006, 0x0008, 0x0300]),
    DeviceType.CONTROL_BRIDGE: ([0x0007], [0x0004, 0x0005, 0x0006, 0x0008, 0x0300]),
    DeviceType.ON_OFF_SENSOR: ([0x0007], [0x0004, 0x0005, 0x0006, 0x0008, 0x0300]),
}

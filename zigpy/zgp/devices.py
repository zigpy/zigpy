...
GPEndpointsByDeviceType: typing.Dict[GPDeviceType, GPDeviceTypeDescriptor] = {
    ...
    GPDeviceType.SWITCH_COLOR_DIMMER: GPDeviceTypeDescriptor("Color Dimmer Switch",out_clusters=[Color]),
    GPDeviceType.SENSOR_LIGHT: GPDeviceTypeDescriptor("Light Sensor", in_clusters=[IlluminanceMeasurement]),
    GPDeviceType.SENSOR_OCCUPANCY: GPDeviceTypeDescriptor("Occupancy Sensor", in_clusters=[OccupancySensing]),
    GPDeviceType.DOOR_LOCK_CONTROLLER: GPDeviceTypeDescriptor("Door Lock Controller", out_clusters=[DoorLock]),
    GPDeviceType.SENSOR_TEMPERATURE: GPDeviceTypeDescriptor("Temperature Sensor", in_clusters=[TemperatureMeasurement]),
    GPDeviceType.SENSOR_PRESSURE: GPDeviceTypeDescriptor("Pressure Sensor", in_clusters=[PressureMeasurement]),
    GPDeviceType.SENSOR_FLOW: GPDeviceTypeDescriptor("Flow Sensor", in_clusters=[FlowMeasurement]),

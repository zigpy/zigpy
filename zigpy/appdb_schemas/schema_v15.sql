...
DROP TABLE IF EXISTS device_scan_progress_v15;
CREATE TABLE device_scan_progress_v15 (
    ieee ieee NOT NULL,
    endpoint_id INTEGER NOT NULL,
    cluster_type INTEGER NOT NULL,
    cluster_id INTEGER NOT NULL,
    manufacturer_code_scope INTEGER,
    manufacturer_code_scope_idx INTEGER NOT NULL GENERATED ALWAYS AS (IFNULL(manufacturer_code_scope, -2)) STORED,
    attr_discovery_complete INTEGER NOT NULL,
    attr_discovery_next_id INTEGER NOT NULL,
    attr_reads_complete INTEGER NOT NULL,
    cmd_rx_complete INTEGER NOT NULL,
    cmd_rx_next_id INTEGER NOT NULL,
    cmd_tx_complete INTEGER NOT NULL,
    cmd_tx_next_id INTEGER NOT NULL,
    last_started REAL,
    last_finished REAL,
...
CREATE UNIQUE INDEX device_scan_progress_idx_v15
    ON device_scan_progress_v15(ieee, endpoint_id, cluster_type, cluster_id, manufacturer_code_scope_idx);

CREATE INDEX idx_device_scan_progress_v15_ieee
    ON device_scan_progress_v15(ieee);


-- device scan attributes
DROP TABLE IF EXISTS device_scan_attributes_v15;
CREATE TABLE device_scan_attributes_v15 (
    ieee ieee NOT NULL,
    endpoint_id INTEGER NOT NULL,
    cluster_type INTEGER NOT NULL,
    cluster_id INTEGER NOT NULL,
...
CREATE UNIQUE INDEX device_scan_attributes_idx_v15
    ON device_scan_attributes_v15(ieee, endpoint_id, cluster_type, cluster_id, manufacturer_code_scope_idx, attr_id);

CREATE INDEX idx_device_scan_attributes_v15_ieee
    ON device_scan_attributes_v15(ieee);

CREATE INDEX idx_device_scan_attributes_v15_pending_reads
    ON device_scan_attributes_v15(ieee, endpoint_id, cluster_type, cluster_id, manufacturer_code_scope_idx, read_complete, attr_id);


-- device scan commands
DROP TABLE IF EXISTS device_scan_commands_v15;
CREATE TABLE device_scan_commands_v15 (
    ieee ieee NOT NULL,
    endpoint_id INTEGER NOT NULL,
    cluster_type INTEGER NOT NULL,
    cluster_id INTEGER NOT NULL,
...
CREATE UNIQUE INDEX device_scan_commands_idx_v15
    ON device_scan_commands_v15(ieee, endpoint_id, cluster_type, cluster_id, manufacturer_code_scope_idx, direction, command_id);

CREATE INDEX idx_device_scan_commands_v15_ieee

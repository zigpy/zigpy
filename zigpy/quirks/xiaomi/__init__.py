...
class TemperatureHumiditySensor(CustomDevice):
    signature = {
        "endpoints": {
            ...
            # device_version=1
            # input_clusters=[3, 18] output_clusters=[4, 3, 5, 18]>
            2: {
                "profile_id": 0x0104,
                "device_type": 0x5F02,
                "input_clusters": [3, 18],
            ...
            # device_version=1
            # input_clusters=[3, 12] output_clusters=[4, 3, 5, 12]>
            3: {
                "profile_id": 0x0104,
                "device_type": 0x5F03,
                "input_clusters": [3, 12],
    ...
    replacement = {
        "endpoints": {1: {"input_clusters": [0x0000, 0x0003, 0x0402, 0x0405]}}
    }
...
class AqaraTemperatureHumiditySensor(CustomDevice):
    ...
    replacement = {
        "endpoints": {1: {"input_clusters": [0x0000, 0x0003, 0x0402, 0x0403, 0x0405]}}
    }
...
class AqaraWaterSensor(CustomDevice):
    signature = {
        "endpoints": {
            ...
            #  device_version=1
            #  input_clusters=[0, 3, 1] output_clusters=[25]>
            1: {
                "profile_id": 0x0104,
                "device_type": 0x0402,
    ...
    replacement = {
        "endpoints": {1: {"input_clusters": [0x0000, 0x0003, 0x0001, 0x0500]}}
    }
...
class AqaraMagicCubeSensor(CustomDevice):
    ...
    replacement = {
        "endpoints": {
            1: {"input_clusters": [Basic.cluster_id, Identify.cluster_id]},
            2: {"input_clusters": [MultistateInput.cluster_id]},
            3: {"input_clusters": [AnalogInput.cluster_id]},
        }
    }

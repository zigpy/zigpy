...
CONF_OTA_ADVANCED_DIR_DEFAULT = None
CONF_OTA_ALLOW_ADVANCED_DIR_DEFAULT = False
CONF_OTA_BROADCAST_ENABLED_DEFAULT = True
CONF_OTA_BROADCAST_INITIAL_DELAY_DEFAULT = 4 * 60 * 60  # 4 hours
CONF_OTA_BROADCAST_INTERVAL_DEFAULT = 4 * 60 * 60  # 4 hours
...
CONF_OTA_Z2M_LOCAL_INDEX_DEFAULT = None
CONF_OTA_Z2M_REMOTE_INDEX_DEFAULT = None

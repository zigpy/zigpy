...
class _ConcentrationCluster(Cluster):
    """Abstract base cluster for the concentration measurement clusters."""
...
class FluorideConcentration(_ConcentrationCluster):
...
class HaloaceticAcidsConcentration(_ConcentrationCluster):
    cluster_id = 0x041D
    name = "Haloacetic Acids Concentration"
    ep_attribute = "haloacetic_acids_concentration"


class TotalTrihalomethanesConcentration(_ConcentrationCluster):
    cluster_id = 0x041E
    name = "Total Trihalomethanes Concentration"
    ep_attribute = "total_trihalomethanes_concentration"


class TotalColiformBacteriaFraction(_ConcentrationCluster):
    cluster_id = 0x041F
...
class Turbidity(_ConcentrationCluster):
...
# XXX: is this a concentration? What are the units?
class PM25(_ConcentrationCluster):
...
class FormaldehydeConcentration(_ConcentrationCluster):
    cluster_id = 0x042B

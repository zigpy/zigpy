...
class Thermostat(Cluster):
    ...
    server_commands = {
        ...
        0x0001: ('set_weekly_schedule', (t.enum8, t.bitmap8, t.bitmap8, t.uint16_t, t.int16s, t.int16s), False),
        0x0002: ('get_weekly_schedule', (t.bitmap8, t.bitmap8), False),
        0x0003: ('clear_weekly_schedule', (), False),
        0x0004: ('get_relay_status_log', (), False),
    }
    client_commands = {
        0x0000: ('get_weekly_schedule_response', (t.enum8, t.bitmap8, t.bitmap8, t.uint16_t, t.int16s, t.int16s), True),

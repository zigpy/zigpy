...
class DoorLock(Cluster):
    ...
    server_commands = {
        ...
        0x0003: ('unlock_with_timeout', (t.uint16_t, t.Optional(t.CharacterString)), False),
        0x0004: ('get_log_record', (t.uint16_t, ), False),
        0x0005: ('set_pin_code', (t.uint16_t, t.uint8_t, t.enum8, t.CharacterString), False),
        ...
        0x000b: ('set_week_day_schedule', (t.uint8_t, t.uint16_t, t.bitmap8, t.uint8_t, t.uint8_t, t.uint8_t, t.uint8_t), False),
        0x000c: ('get_week_day_schedule', (t.uint8_t, t.uint16_t), False),
        0x000d: ('clear_week_day_schedule', (t.uint8_t, t.uint16_t), False),
        0x000e: ('set_year_day_schedule', (t.uint8_t, t.uint16_t, t.uint32_t, t.uint32_t), False),
        0x000f: ('get_year_day_schedule', (t.uint8_t, t.uint16_t), False),
        0x0010: ('clear_year_day_schedule', (t.uint8_t, t.uint16_t), False),
        0x0011: ('set_holiday_schedule', (t.uint8_t, t.uint32_t, t.uint32_t, t.enum8), False),
        ...
        0x0016: ('set_rfid_code', (t.uint16_t, t.uint8_t, t.enum8, t.CharacterString), False),
    ...
    client_commands = {
        ...
        0x0004: ('get_log_record_response', (t.uint16_t, t.uint32_t, t.enum8, t.uint8_t, t.uint8_t, t.uint16_t), True),
        0x0005: ('set_pin_code_response', (foundation.Status, ), True),
        0x0006: ('get_pin_code_response', (t.uint16_t, t.uint8_t, t.enum8, t.CharacterString), True),
        ...
        0x000c: ('get_week_day_schedule_response', (t.uint8_t, t.uint16_t, t.uint8_t, t.uint8_t, t.uint8_t, t.uint8_t, t.uint8_t, t.uint8_t), True),
        ...
        0x000f: ('get_year_day_schedule_response', (t.uint8_t, t.uint16_t, foundation.Status, t.uint32_t, t.uint32_t), True),
        ...
        0x0012: ('get_holiday_schedule_response', (t.uint8_t, foundation.Status, t.uint32_t, t.uint32_t, t.enum8), True),
        ...
        0x0017: ('get_rfid_code_response', (t.uint16_t, t.uint8_t, t.enum8, t.CharacterString), True),
        0x0018: ('clear_rfid_code_response', (foundation.Status, ), True),
        0x0019: ('clear_all_rfid_codes_response', (foundation.Status, ), True),
        0x0020: ('operation_event_notification', (t.uint8_t, t.uint8_t, t.uint16_t, t.uint8_t, t.uint32_t, t.CharacterString), False),
        0x0021: ('programming_event_notification', (t.uint8_t, t.uint8_t, t.uint16_t, t.uint8_t, t.uint8_t, t.uint8_t, t.uint32_t, t.CharacterString), False),
    }
